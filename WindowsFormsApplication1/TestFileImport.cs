...
namespace WFHelper
{
    public partial class TestFileImport : Form
    {
        ...
        {
            fileImportStatusLabel.Text = value;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var fileName = TestFilesDirectory + comboBox1.Text + comboBox2.Text + ".feds";

                if (File.Exists(fileName))
                {
                    var dResult = MessageBox.Show(Resources.Resources.TestFileImport_button2_Click_Are_you_sure__, Resources.Resources.TestFileImport_button2_Click_Update_confirmation, MessageBoxButtons.YesNo);
        ...
        private void ShowImportLogs(Boolean showMessageBox = false)
        {
            ...
            try
            {
                ...
                foreach (var dir in directoryList)
                {
                    ...
                    else if (fileList.Length == 1)
                    {
                        ...
                        {
                            MessageBox.Show(
                                Resources.Resources.TestFileImport_ShowImportLogs_File_Imported_without_Errors);
                        }
                        else
                        {
                            Invoke(new UpdateLabelDelegate(UpdateLabelSafe),
                                   Resources.Resources.TestFileImport_ShowImportLogs_File_Imported_without_Errors);
                        }
                    }
                }
            ...
            catch
            {
                ...
                {
                    Invoke(new UpdateLabelDelegate(UpdateLabelSafe), Resources.Resources.TestFileImport_ShowImportLogs_Log_folder_didn_t_contains_any_files_);
                }
            }
        }
