...
namespace WFHelper.User_Classes
{
    class FirstLaunch
    {
        ...
        public FirstLaunch()
        {
            ...
            FilesList.Add("WebBuild", "cd C:\\jv\\sps\\builder && webbuild -Dhub=<HUB> docViews  >" + LogsDirectory + "webbuild.log");
            FilesList.Add("WebDeploy", "cd C:\\jv\\sps\\builder && webdeploy all >" + LogsDirectory + "webdeploy.log");
